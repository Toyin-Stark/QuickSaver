...
class StoryView : AppCompatActivity(),SwipeRefreshLayout.OnRefreshListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imageID = intentID.getString("imageID")
        val nameID  = intentID.getString("nameID")
        val followID = intentID.getString("followID")
        swipes.setOnRefreshListener { this }

        username.text = nameID
        followers.text = followID
